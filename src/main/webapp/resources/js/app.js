...
$(function() {
    ...
    function drawFlotCharts() {
        ...
        container.empty();
        // Determine how many data points to keep based on the placeholder's
		// initial size;
        // this gives us a nice high-res plot while avoiding more than one point
		// per pixel.
...
$(function () {
	...
	function setThemeState() {
		...
		if (themeSettings.themeName) {
			$styleLink.attr('href', '/admin/resources/css/app-' + themeSettings.themeName + '.css');
		}
		else {
			$styleLink.attr('href', '/admin/resources/css/app.css');
		}
